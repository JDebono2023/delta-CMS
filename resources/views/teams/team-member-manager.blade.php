                            ...
                            <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                                ...
                                @else
                                    <button type="button"
                                        ...
                                        {{-- class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 {{ $index > 0 ? 'border-t border-gray-200 focus:border-none rounded-t-none' : '' }} {{ !$loop->last ? 'rounded-b-none' : '' }}" --}} wire:click="$set('addTeamMemberForm.role', 'delta')">
                                        <div>
                                            <!-- Role Name -->
                                            <div class="flex items-center">
                                                <div
                                                    class="text-sm text-gray-600 {{ $addTeamMemberForm['role'] == 'delta' ? 'font-semibold' : '' }}">
                                                    Delta User
                                                </div>

                                                @if ($addTeamMemberForm['role'] == 'delta')
                                                    <svg class="ml-2 h-5 w-5 text-green-400"
                                                        xmlns="http://www.w3.org/2000/svg" fill="none"
                                            ...
                                            <!-- Role Description -->
                                            <div class="mt-2 text-xs text-gray-600 text-left">
                                                Users have access to the the scheduling system and adding or removing
                                                permitted users.
                                            </div>
                                        </div>
                                    </button>
